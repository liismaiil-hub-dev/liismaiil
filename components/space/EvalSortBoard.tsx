...
export default function EvalBoardSorted() {
    ...
    const { sprints, gridSelected, orderedAyahsContext, shuffeledAyahsContext, gridIndexContext } = useSelector((state: RootStateType) => state.stage)
    ...
    const { setSprints, setGridSelected } = stageActions
