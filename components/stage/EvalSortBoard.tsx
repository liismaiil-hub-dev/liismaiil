...
export default function EvalBoardSorted({ grid, evalIndex, hideNb, arabName }: { grid: AyahTabletType[], evalIndex: number, hideNb: boolean, arabName: string },) {
    ...
    const { sprints, spaceSprint, gridSelected, sprintsTitles, spaceStage } = useSelector((state: RootStateType) => state.stage)
    ...
    const { setSprints, setSprintsTitles, emptySprintsTitles, setGridsSelected, setGridSelected, setAyahArraySelected, hideAy, resetHidedAy, setMinMax } = stageActions
